...
export default function RegisterForm({
  ...
  return (
    <form
      ...
      className="flex flex-col w-[95vw] h-max max-w-3xl items-center bg-white p-4 py-8 my-5 rounded-lg shadow-md  z-50"
    >
      <div>
        <h1 className="text-4xl sm:text-5xl font-bold mb-2 text-center text-primary">
          Crear Cuenta
        </h1>
