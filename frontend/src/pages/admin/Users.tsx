...
function Users() {
  ...
  if (isLoading)
    return (
      <div className="mt-6 m-auto w-[90vw]">
        <h1 className="flex gap-1 font-bold text-[#222831] mb-2 sm:text-5xl text-4xl"><BiSolidUserAccount/> Usuarios:</h1>
  ...
  return (
    <div className="mt-6 m-auto w-[90vw]">
      <h1 className="flex gap-1 font-bold text-[#222831] mb-2 sm:text-5xl text-4xl"><BiSolidUserAccount/> Usuarios:</h1>
      <p className="text-gray-900 w-fit text-xl mb-4 pr-16">
